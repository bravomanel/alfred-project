   ...
   return (
      <main>
         ...
         <div id="tips" className="recipeStyle">
            <h3>Tips</h3>
               <p>The dough must be at least 5cm tall, use a small size tray</p>
               <p>Use parchment paper with butter or oil below to grease</p>
               <p>Let it cool for about 10m on the tray, after this let it cool outside the tray</p>
               <p>You may use Vanilla Extract, Coffee Powder and Salt to enhance the flavours</p>
               <p>Sprinkle a bit of salt after halfway through cooking to enhance even more flavours</p>
               <p>Beat the eggs and sugar for a long time for maximum aeration</p>
               <p>Don't mix the 'dough' too much after putting the flour</p>
         </div>
